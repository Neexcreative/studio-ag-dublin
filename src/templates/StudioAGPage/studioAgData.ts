...
export const studioAgTestimonials = [
  {
    stars: '★★★★★',
    quote:
      'First time to get this facial and it was amazing. Arieli is very friendly and an amazing professional. Would definitely recommend.',
    name: 'Priscila Rocha',
  ...
  },
  {
    stars: '★★★★★',
    quote:
      'An amazing experience at AG studio! Lovely relaxing music and wonderful hands! I could feel my muscles relaxing and my energy flowing all the way through! Recommended',
    name: 'Natacha S.',
    service: 'Personalised Facial',
  ...
  },
  {
    stars: '★★★★★',
    quote:
      'Great experience and the difference after, my stomach was no longer bloated, I had been suffering with inflammation for 2 weeks and the 90 minute lymphatic drainage massage made a big difference, I will be backx',
    name: 'Jamie Whelan',
...
export const studioAgFaq = [
  {
    ...
    answer:
      "The AG Method, created by Brazilian therapist Arieli Garcia, is an exclusive 100% manual lymphatic drainage technique designed to deliver immediate results. The method works by reducing swelling and releasing diaphragm blockages, promoting an instant feeling of lightness and well-being—especially in the abdominal area and legs. In addition to decreasing edema, fluid retention, and cellulite, the AG Method also supports body contouring, enhancing the body’s natural curves from the very first session.",
  },
  {
